      ...
      <footer className="footer" role="contentinfo">
        <div className="container">
          <div className="footer-grid">
            {/* Brand column — local white/black VUT logo SVG */}
            <div className="footer-brand">
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
                <img
                    src="/images/vut-logo-black-white-60years.svg"
                    alt="Vaal University of Technology — 1966–2026"
              ...
              <div style={{ fontSize: '0.75rem', opacity: 0.6, marginBottom: 10 }}>
