 ...
 * Using inline SVG instead of icon fonts: better performance, no FOUC,
 * fully styleable with CSS currentColor, and zero external requests.
 *
 * Each icon component accepts { size, className, ...props }
 * and uses currentColor so CSS color applies directly.
 */
...
/** VUT Logo SVG — the characteristic linked U mark */
export function VUTLogo({ size = 40, className = '', ...p }) {
    return (
        <svg width={size} height={size} viewBox="0 0 100 100" fill="none"
             xmlns="http://www.w3.org/2000/svg" className={className} {...p}>
            {/* VUT-inspired geometric U mark */}
            <rect width="100" height="100" rx="8" fill="#0033a0"/>
            {/* Gold lines forming the layered U shape */}
            <path d="M25 20 L25 60 Q25 80 50 80 Q75 80 75 60 L75 20"
                  stroke="#FFD100" strokeWidth="7" fill="none" strokeLinecap="round"/>
            <path d="M33 20 L33 60 Q33 72 50 72 Q67 72 67 60 L67 20"
                  stroke="#FFD100" strokeWidth="5" fill="none" strokeLinecap="round" opacity="0.7"/>
            <path d="M41 20 L41 60 Q41 64 50 64 Q59 64 59 60 L59 20"
                  stroke="#FFD100" strokeWidth="4" fill="none" strokeLinecap="round" opacity="0.45"/>
        </svg>
    );
}
